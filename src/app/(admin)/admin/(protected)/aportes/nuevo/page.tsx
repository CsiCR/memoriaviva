    ...
    try {
      ...
      const payload = {
        contributor: {
          ...
          neighborhood_or_institution: formData.neighborhood_or_institution?.trim() || null,
        ...
        contribution: {
          ...
          exact_date: formData.exact_date || null,
          approximate_decade: formData.approximate_decade?.trim() || null,
          related_place: formData.related_place.trim(),
          mentioned_people: formData.mentioned_people?.trim() || null,
          related_institution: formData.related_institution?.trim() || null,
          historical_context: formData.historical_context?.trim() || null,
          ...
          consent_reference: formData.consent_reference?.trim() || null
        },
        consent: {
        ...
        new_agreement_name: formData.new_agreement_name?.trim() || null,
        new_agreement_institution: formData.new_agreement_institution?.trim() || null
      };
